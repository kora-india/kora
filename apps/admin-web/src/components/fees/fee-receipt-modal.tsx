        ...
        <div class="receipt-container">
          ...
          <div class="footer-box">
            <div class="footer-flex">
              <div><strong>Payment Mode:</strong> ${receiptData.paymentType}</div>
              <div><strong>Generated By:</strong> ${receiptData.generatedBy}</div>
            </div>
            <div>
              <em>This is a computer-generated Fee Payment Receipt and does not require a physical signature.</em>
              ${
                remainingBalance > 0
                  ? `<span style="display:block; color: #b45309; font-weight: 600; margin-top: 2px;">
                      Notice: Outstanding dues of ₹${remainingBalance.toFixed(2)} remain. Please clear before next billing cycle.
                    </span>`
                  : ""
              }
            </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <div className="relative w-full max-w-3xl bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800 overflow-hidden my-6">
        ...
        <div className="p-4 sm:p-6 bg-neutral-100 dark:bg-neutral-950/50 flex justify-center max-h-[75vh] overflow-y-auto">
          ...
          <div className="w-full max-w-[560px] bg-white text-neutral-900 p-6 sm:p-7 shadow-lg border border-neutral-300 font-sans select-none rounded-sm">
            {/* School Header */}
            ...
            <div className="mt-4 pt-3 border-t border-dashed border-neutral-300 text-xs text-neutral-600 space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <span>
                  <strong>Generated By:</strong> {receiptData.generatedBy}
                </span>
              </div>
              <p className="text-[10.5px] italic text-neutral-500">
                This is a computer-generated Fee Payment Receipt and does not
              ...
              {remainingBalance > 0 && (
                <div className="p-2 rounded bg-amber-50 border border-amber-200 text-amber-900 text-[11px] font-medium flex items-center gap-1.5">
                  ...
                  <span>
                    Outstanding balance of ₹{remainingBalance.toFixed(2)}{" "}
                    remains due. Please ensure timely clearance.
                  </span>
                </div>
              )}
            </div>
            ...
            {/* Signature Area */}
            <div className="flex justify-between items-end pt-6 mt-4 text-[10px] text-neutral-700 font-semibold">
              <div className="text-center border-t border-neutral-400 pt-1 w-32">
                Cashier / Accountant
              </div>
              <div className="text-center border-t border-neutral-400 pt-1 w-32">
                Parent / Guardian
