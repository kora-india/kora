...
const SetupSchema = z.object({
  ...
  expectedStudents: z.preprocess(
    (val) => Number(val),
    z.number().min(1, "Expected students is required"),
  ),
  expectedStaff: z.preprocess(
    (val) => Number(val),
    z.number().min(1, "Expected staff is required"),
  ),
...
const PLANS = [
  {
    ...
    name: "Basic",
    price: "₹999/mo",
    features: ["Up to 500 Students", "Basic Analytics", "Standard Support"],
  },
  {
    id: "PRO",
    name: "Pro",
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-3xl text-center mb-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          You're just a few steps away from your new dashboard.
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {PLANS.map((plan) => (
                    ...
                    >
                      ...
                      <p className="text-2xl font-black mt-2 text-violet-600 dark:text-violet-400">
                        {plan.price}
                      </p>
            ...
            <div className="flex justify-between pt-8 border-t border-zinc-100 dark:border-zinc-800 max-w-xl mx-auto">
              ...
              {step < 3 ? (
                ...
                >
                  {isValidatingSubdomain ? "Checking..." : "Continue"}{" "}
